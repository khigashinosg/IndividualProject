...
plt.savefig(f'/Users/kyhi2018/Desktop/Individual Project/Python Plots/ML Results/ML Methods Compare/tilNov11Train.png',bbox_inches='tight',dpi=200) # saves all figures in specified folder
fig.clf()
