...
for area_select in [0,1,2]: # 0 = ML, 1 = SC, 2 = SL
    ...
    for method_select in [0,1,2]: # 0 = Multiple Regression, 1 = Random Forest, 2 = Support Vector Regression
        ...
        x = data.iloc[:,2:] # selects all features (including relative occupancy)
...
plt.savefig(f'/Users/kyhi2018/Desktop/Individual Project/Python Plots/ML Results/ML Methods Compare/T1Train (RelOcc).png',bbox_inches='tight',dpi=200) # saves all figures in specified folder
fig.clf()